    ...
    <>
      ...
      <Animate>
        ...
        Click me
          ...
          <div
            className={`${isUpgradeModalVisible === true ? "visible" : "invisible"
            ...
            <div className="w-full flex flex-col justify-between py-8">
              ...
              <div className="w-full flex justify-center flex-col items-center">
                ...
                <p className="pb-6 text-[#9a96a6] text-[16px] text-center">
                  Increase amount of Coins you can earn per one tap <br />
          ...
          <div
            className={`${isUpgradeModalVisibleEn === true ? "visible" : "invisible"
              } absolute bottom-0 left-0 right-0 h-fit bg-[#1e2340f7] z-[100] rounded-tl-[20px] rounded-tr-[20px] flex justify-center px-4 py-5`}
          >
            <div className="w-full flex flex-col justify-between py-8">
              <button
              ...
              <div className="w-full flex justify-center pb-6 pt-4">
                <button
                  ...
                  className={`${!hasSufficientBalanceEn ? 'bg-btn2 text-[#979797]' : 'bg-gradient-to-b from-[#3a5fd4] to-[#5078e0]'} w-full py-5 px-3 flex items-center justify-center text-center rounded-[12px] font-semibold text-[22px]`}
                >
            ...
            <div className="w-full flex flex-col justify-between py-8">
              ...
              <div className="w-full flex justify-center pb-6 pt-4">
                <button
                  ...
                  className={`${!hasSufficientBalanceEnc ? 'bg-btn2 text-[#979797]' : 'bg-gradient-to-b from-[#3a5fd4] to-[#5078e0]'} w-full py-5 px-3 flex items-center justify-center text-center rounded-[12px] font-semibold text-[22px]`}
                >
          ...
          <div
            className={`${guru === true ? "visible" : "invisible"
              } absolute bottom-0 left-0 right-0 h-fit bg-[#1e2340f7] z-[100] rounded-tl-[20px] rounded-tr-[20px] flex justify-center px-4 py-5`}
          >
            <div className="w-full flex flex-col justify-between py-8">
              <button
          ...
          <div
            className={`${bot === true ? "visible" : "invisible"
              } absolute bottom-0 left-0 right-0 h-fit bg-[#1e2340f7] z-[100] rounded-tl-[20px] rounded-tr-[20px] flex justify-center px-4 py-5`}
          >
            <div className="w-full flex flex-col justify-between py-8">
              <button
